...
const AboutSocioSpace = () => {
  return (
    <section
      id="aboutSection"
      className="px-4 py-12 sm:py-16 md:px-0 md:py-20 lg:py-28"
    >
          ...
          <div className="flex justify-center md:col-span-2 lg:col-span-1">
            <div className="w-full space-y-4 sm:space-y-6">
              ...
              <p className="text-sm font-light sm:text-base">
                ...
                We&apos;re dedicated to creating a space where professionals
                like you can thrive, grow, and network. Join us today to immerse
                yourself in a co-working experience that transcends the
                ordinary, and embark on a journey of professional and personal
                growth.
              </p>
